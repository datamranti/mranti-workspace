...
export async function callLiveEndpoint(endpointName, payload, authContext, config, options = {}) {
  ...
  if (!currentUser) throw new Error("Your MRANTI session has expired. Sign in again.");
  if (!accessToken) throw new Error("Google Workspace authorisation is required for this action.");
