...
function renderConversationContext(latestTurn) {
  const turns = previousConversationTurns(latestTurn);
  ...
  return `<section class="conversation-context" aria-labelledby="conversation-context-title">
    <div class="conversation-context-head">
      ...
      <span class="conversation-context-count">${turns.length} earlier turn${turns.length === 1 ? "" : "s"}</span>
    </div>
...
function renderIntelligenceContent(message, sources) {
  if (!message) return "";
...
function renderGenericConversation(options = {}) {
  ...
  elements.viewRoot.innerHTML = `<section class="conversation-view intelligence-view" aria-labelledby="intelligence-title"><div class="intelligence-container" id="intelligence-top">
    ...
    <main class="intelligence-content">${state.loading ? renderLoadingWorkspace(turn.user) : renderIntelligenceContent(assistant, sources)}</main>
