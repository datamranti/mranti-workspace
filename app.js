...
async function runLiveConversation(message) {
  ...
  try {
    ...
    const resolvedTitle = continuingConversation
      ? (state.activeConversation.title || chooseConversationTitle(message, response.title))
      : chooseConversationTitle(message, response.title);
